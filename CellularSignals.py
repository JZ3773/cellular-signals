...
#The username and password should replace the words "username" and "password"(this also applies below).
URL = "https://Username:Password@electrosense.org/api/sensor/list"
